...
const listDisplayContainer = document.querySelector('[data-list-container]')
...
const clearComplete = document.querySelector('[data-clear-completed-task]')
...
function renderTaskCount(selectedList){
    ...
    const taskString = incompleteTaskCount.length === 1? 'task' : 'tasks'
